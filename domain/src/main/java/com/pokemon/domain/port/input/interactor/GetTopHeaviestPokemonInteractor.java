...
public class GetTopHeaviestPokemonInteractor implements GetTopHeaviestPokemonUseCase {
    ...
    public OutputValues execute(final InputValues input) throws Exception {
        final List<Pokemon> pokemonList = pokemonRepository.retrieveTopHeaviestPokemon(input.getLimit());
